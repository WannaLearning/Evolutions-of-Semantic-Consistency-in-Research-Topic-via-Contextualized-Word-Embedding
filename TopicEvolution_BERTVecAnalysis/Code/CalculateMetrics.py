...
def calculate_self_similarity_func(vec_1, vec_2, bSameFoS, sampling_size, max_mp_num, min_sampling_times, max_sampling_times, sampling_discount_ratio):
...
def calculate_self_distance_func(vec_1, vec_2, bSameFoS, sampling_size, max_mp_num, min_sampling_times, max_sampling_times, sampling_discount_ratio):
